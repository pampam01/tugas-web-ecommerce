      ...
      <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden lg:flex space-x-4 mr-8">
          <a
            wire:navigate
            href="/"
            class="font-serif text-lg rounded-xl hover:bg-slate-700 hover:text-white px-3 py-2 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200 {{ request()->is('/') ? 'bg-slate-700 text-white px-3 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0)]' : '' }}"
          >
            Home
          </a>
          ...
          <a
            wire:navigate
            href="/products"
            class="font-serif text-lg rounded-xl hover:bg-slate-700 hover:text-white px-3 py-2 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200 {{ request()->is('products') ? 'bg-slate-700 text-white px-3 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0)]' : '' }}"
          >
            Catalogs
          </a>
          @guest
          ...
          <a
            wire:navigate
            href="/cart"
            class="relative font-serif text-lg rounded-xl hover:bg-slate-700 hover:text-white px-3 py-2 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200 hidden lg:flex {{ request()->is('cart') ? 'bg-slate-700 text-white px-3 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0)]' : '' }}"
          >
      ...
      >
        <div class="flex flex-col space-y-2">
          ...
          <a
            wire:navigate
            href="/categories"
            class="font-serif text-lg rounded-xl hover:bg-slate-700 hover:text-white px-3 py-2 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200 {{ request()->is('categories') ? 'bg-slate-700 text-white px-3 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0)]' : '' }}"
          >
            Categories
          </a>
          <a
