                    ...
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                                ...
                                @foreach ($categories as $cat)
                                    <li class="mb-4" wire:key="{{ $cat->id }}">
                                        <label for="{{ $cat->slug }}" class="flex items-center dark:text-gray-400 ">
                                            <input type="checkbox" class="w-4 h-4 mr-2" id="{{ $cat->slug }}"
                                                value="{{ $cat->id }}" wire:model.live="selected_categories">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div class="font-semibold">
                                {{ Number::currency($price_range, 'IDR', 'Rp.') }}
                                <input type="range"
                                ...
                                <div class="flex justify-between ">
                                    <span class="inline-block text-lg font-bold text-blue-400 ">
                                        {{ 'Rp. ' . number_format(100000, 0, ',', '.') }}</span>
                                    <span class="inline-block text-lg font-bold text-blue-400 ">
                                        {{ 'Rp. ' . number_format(2000000, 0, ',', '.') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $prod->id }}">
                                    <div class="border border-gray-300 dark:border-gray-700">
                                        <div class="relative bg-gray-200">
                                            <a href="/products/{{ $prod->slug }}" class="" wire:navigate>
                                                <img src="{{ url('storage', $prod->images[0]) }}" alt=""
                                        ...
                                        <div class="p-3 ">
                                            ...
                                            <p class="text-lg ">
                                                <span
                                                    class="text-green-600 dark:text-green-600">{{ Number::currency($prod->price, 'IDR') }}</span>
                                            </p>
                                        </div>
                                        <div
                                            class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                                            <a wire:click.prevent="addToCart({{ $prod->id }})" href="#"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    wire:target="addToCart({{ $prod->id }})">Add to Cart</span>
                                                <span wire:loading wire:target="addToCart({{ $prod->id }})">
                                                    Adding...
                                                </span>
                                            </a>
