        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <span
                            class="{{ $status }} py-1 px-3 rounded text-white shadow">{{ $order->status }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            ...
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <span
                            class="{{ $payment }} py-1 px-3 rounded text-white shadow">{{ $order->payment_status }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($order_items as $item)
                            <tr wire:key="cart-item-{{ $item->id }}">
                                ...
                                <td class="py-4">{{ 'Rp. ' . number_format($item->product->price, 0, ',', '.') }}
                                </td>
                                <td class="py-4">
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span
                        class="font-semibold">{{ 'Rp. ' . number_format($item->order->grand_total, 0, ',', '.') }}</span>
                </div>
