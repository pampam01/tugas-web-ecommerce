                ...
                <div class="p-4 sm:p-7">
                    ...
                    <form wire:submit.prevent='save'>
                        ...
                        <div class="grid gap-y-4">
                            <!-- Form Group -->
                            <div>
                                <label wire:model='email' for="email"
                                    class="block text-sm mb-2 dark:text-white">Email address</label>
                                <div class="relative">
...
<?php /**PATH D:\coding\smester-5\web programming\laravel prayitno 8020220066\testing\testing4\resources\views/livewire/auth/login-page.blade.php ENDPATH**/ ?>