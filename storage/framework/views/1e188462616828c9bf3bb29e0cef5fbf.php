            ...
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <div><?php echo e($address->full_name); ?></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200">
                            <?php echo e($order_items[0]->created_at->format('d-m-Y')); ?>
        ...
        <div class="md:w-3/4">
                                ...
                                <td class="py-4">
                                    <div class="flex items-center">
                                        <img class="h-16 w-16 mr-4"
                                            src="<?php echo e(asset('storage/' . $item->product->images[0])); ?>"
                                            alt="<?php echo e($item->product->name); ?>">
                                        <span class="font-semibold"><?php echo e($item->product->name); ?></span>
                                    </div>
                                </td>
                                <td class="py-4"><?php echo e('Rp. ' . number_format($item->product->price, 0, ',', '.')); ?>

                                </td>
                                <td class="py-4">
                                    <span class="text-center w-8"><?php echo e($item->quantity); ?></span>
                                </td>
                                <td class="py-4"><?php echo e('Rp. ' . number_format($item->total_amount, 0, ',', '.')); ?></td>
                            </tr>
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p><?php echo e($address->street_address); ?>, <?php echo e($address->city); ?>, <?php echo e($address->state); ?>,
                            <?php echo e($address->zip_code); ?></p>
                    </div>
                    <div>
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span><?php echo e('Rp. ' . number_format($item->order->grand_total, 0, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                    <span>0</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span
                        class="font-semibold"><?php echo e('Rp. ' . number_format($item->order->grand_total, 0, ',', '.')); ?></span>
                </div>
...
<?php /**PATH D:\coding\smester-5\web programming\laravel prayitno 8020220066\testing\testing4\resources\views/livewire/my-order-detail-page.blade.php ENDPATH**/ ?>