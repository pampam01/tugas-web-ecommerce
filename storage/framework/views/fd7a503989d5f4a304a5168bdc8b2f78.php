            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium <?php echo e(request()->is('/') ? 'text-blue-600' : 'text-gray-500'); ?> hover:text-gray-400 py-3 md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/" aria-current="page">Home</a>

                        <a wire:navigate
                            class="font-medium <?php echo e(request()->is('categories') ? 'text-blue-600' : 'text-gray-500'); ?> hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/categories">
                            Categories
                        </a>

                        <a wire:navigate
                            class="font-medium <?php echo e(request()->is('products') ? 'text-blue-600' : 'text-gray-500'); ?> hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/products">
                            Products
                        </a>

                        <a wire:navigate
                            class="font-medium flex items-center <?php echo e(request()->is('cart') ? 'text-blue-600' : 'text-gray-500'); ?> hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                            ...
                            <span class="mr-1">Cart</span> <span
                                class="py-0.5 px-1.5 rounded-full text-xs font-medium bg-blue-50 border border-blue-200 text-blue-600"><?php echo e($total_count); ?></span>
                        </a>
...
<?php /**PATH D:\coding\smester-5\web programming\laravel prayitno 8020220066\testing\testing4\resources\views/livewire/partials/navbar.blade.php ENDPATH**/ ?>