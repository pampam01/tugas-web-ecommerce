                        ...
                        <div class="flex-wrap hidden md:flex ">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='<?php echo e(url('storage', $image)); ?>'">
                                    <img src="<?php echo e(url('storage', $image)); ?>" alt="<?php echo e($product->name); ?>"
                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click="addToCart(<?php echo e($product->id); ?>)"
                                ...
                                <span wire:loading.remove wire:target="addToCart(<?php echo e($product->id); ?>)">Add to
                                    cart</span>
...
<?php /**PATH D:\coding\smester-5\web programming\laravel prayitno 8020220066\testing\testing4\resources\views/livewire/product-detail-page.blade.php ENDPATH**/ ?>