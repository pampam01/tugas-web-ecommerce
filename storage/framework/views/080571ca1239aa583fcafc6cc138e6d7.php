            ...
            <div>
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  <span
                    ><?php echo e('Rp. ' . number_format($price_range, 0, ',', '.')); ?></span
                  >
                </div>
                <input
                  type="range"
                ...
                <div class="flex justify-between text-sm text-gray-600">
                  <span><?php echo e('Rp. ' . number_format(100000, 0, ',', '.')); ?></span>
                  <span><?php echo e('Rp. ' . number_format(2000000, 0, ',', '.')); ?></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex-1 order-2">
          ...
          >
            ...
            <div class="flex flex-wrap items-center space-x-2">
              ...
              <!--[if BLOCK]><![endif]--><?php if(!empty($selected_categories)): ?>
              <div class="flex items-center space-x-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selected_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $category =
                $categories->firstWhere('id', $cat_id); ?> <!--[if BLOCK]><![endif]--><?php if($category): ?>
                <span
                  class="px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded-full flex items-center space-x-2"
                >
                  <span><?php echo e($category->name); ?></span>
                </span>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]--> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
              </div>
              <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

              <!-- Display Active Brands -->
              <!--[if BLOCK]><![endif]--><?php if(!empty($selected_brands)): ?>
              <div class="flex items-center space-x-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selected_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $brand =
                $brands->firstWhere('id', $brand_id); ?> <!--[if BLOCK]><![endif]--><?php if($brand): ?>
                <span
              ...
              <!--[if BLOCK]><![endif]--><?php if($featured): ?>
              <span
          ...
          >
            ...
            >
              <div class="relative">
                <!-- Label SALE -->
                <!--[if BLOCK]><![endif]--><?php if($prod->is_featured): ?>
                <h1
                ...
                <!-- Product Image -->
                <img
                  src="<?php echo e(url('storage', $prod->images[0])); ?>"
                ...
                <a
                  wire:navigate
                  href="/products/<?php echo e($prod->slug); ?>"
              ...
              <div class="p-4">
                ...
                <div class="mt-4 font-semibold font-lora">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <a href="#" wire:click.prevent="addToCart(<?php echo e($prod->id); ?>)">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
...
<?php /**PATH D:\ecommerceweb\resources\views/livewire/products-page.blade.php ENDPATH**/ ?>