                        ...
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                ...
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                                    <?php echo e($order->address->street_address); ?></p>
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                                    <?php echo e($order->address->city); ?> <?php echo e($order->address->state); ?>,
                                    <?php echo e($order->address->zip_code); ?>,
                                </p>
                                <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">Nomor Hp:
                                    <?php echo e($order->address->phone); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                                        <?php echo e('Rp. ' . number_format($order->grand_total, 0, ',', '.')); ?></p>
                                </div>
...
<?php /**PATH D:\coding\smester-5\web programming\laravel prayitno 8020220066\testing\testing4\resources\views/livewire/success-page.blade.php ENDPATH**/ ?>